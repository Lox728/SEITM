...
def modele_enterHoover(e):
    global msgboxModele
    msgboxModele = tk.Label(wnd,text='Our first year report', font='Helvetica 10 italic')
...
def appliquer_Fonction():
    ...
    tailleAff.configure(text=f"Length of the map : {len(carte)}x{len(carte)}")
...
def page_Accueil():
    ...
    titre = tk.Label(wnd, text="Fouloscopy at the service of epidemiology", font='Helvetica 19 bold italic', background='white')
    titre.place(x=350,y=50)
    
    Button1 = tk.Button(wnd, text="Simulate an epidemic", font='Helvetica 13 bold', command=page_Tuto1, relief='groove')
...
def page_Tuto1():
    ...
    Suite = tk.Button(wnd, text="Next", command=page_Données)
...
def page_Données():
    ...
    c1.place(x=20,y=430)
    c2 = tk.Checkbutton(wnd, text='Hospital tension',variable=tensHosp, onvalue=1, offvalue=0, command=None)
    c2.place(x=20,y=460)
    ...
    Button2 = tk.Button(wnd, text='Run the simulation', command=lancerSim_Fonction)
...
def prévisualisation_Densité():
    ...
    tailleAff = tk.Label(wnd, text=f"Length of the map : {len(carte)}x{len(carte)}")
    tailleAff.place(x=720,y=550)
    
    procedureDens = tk.Label(wnd, text = u"(\u25B6 More Informations)", borderwidth=0)
    ...
    slider_label = ttk.Label(wnd, text='Importance of the density factor :')
...
def menu_Déroulant():
    ...
    titre2 = tk.Label(wnd,text='Density map applied :', font='Helvetica 18 bold')
    ...
    listebox.insert(0, "map0")
    listebox.insert(1, "map1")
    listebox.insert(2, "map2")
    listebox.insert(3, "map3")
    listebox.insert(4, "map4")
    listebox.insert(5, "map5")
    listebox.insert(6, "map6")
    listebox.insert(7, "map7")
    listebox.insert(8, "map8")
    listebox.insert(9, "map9")
    listebox.insert(10, "map10")
    
    appliquer_Button = tk.Button(wnd, text='Apply', command=appliquer_Fonction)
...
def formulaire_Données():
    ...
    titre1 = tk.Label(wnd,text="Simulation's data :" , font='Helvetica 18 bold')
    titre1.place(x=20, y=100)

    valeur1 = tk.Entry(wnd, width = 5)
    valeur1.place(x=20, y=150)
    msg1 = tk.Label(wnd, text=" : Number of days of the simulation")
    ...
    msg2 = tk.Label(wnd, text=" : Length of the square matrix")
    ...
    msg3 = tk.Label(wnd, text=" : Number of persons infected at the beginning")
    ...
    msg4 = tk.Label(wnd, text=" : Infectiouness rate")
    ...
    msg5 = tk.Label(wnd, text=" : Incubation period")
    ...
    msg6 = tk.Label(wnd, text=" : Recovery period")
    ...
    msg7 = tk.Label(wnd, text=" : Immunity period")
    ...
    msg8 = tk.Label(wnd, text=" : Death rate")
...
def page_Simulation():
    ...
    compteur = tk.Label(wnd, text='Day : 0', font='Helvetica 13 bold')
    ...
    commencerSim = tk.Button(wnd, text='Start the simulation', command=commencerSim_Fonction)
...
def données_PageSim():
    ...
    msg1 = tk.Label(wnd, text='Number of days of the simulation : ' + str(nbr_jour))
    msg1.place(x=610,y=50)
    
    msg2 = tk.Label(wnd, text='Number of persons : ' + str(longueur**2))
    msg2.place(x=610, y=80)

    msg3 = tk.Label(wnd, text='Number of persons infected at the beginning : ' + str(inf))
    msg3.place(x=610, y=110)

    msg4 = tk.Label(wnd, text="Incubation period : " + str(pei))
    msg4.place(x=610, y=140)

    msg5 = tk.Label(wnd, text="Infectiouness rate : " + str(tse))
    msg5.place(x=610, y=170)

    msg6 = tk.Label(wnd, text="Immunity period : " + str(pts))
    msg6.place(x=610, y=200)

    msgtim = tk.Label(wnd, text='Death rate : ' + str(tim))
    msgtim.place(x=610, y=230)

    msg8 = tk.Label(wnd, text='Recovery period : ' + str(pit))
...
def Exécuter_SEITM(nbr_jour,longueur,nbr_infecté):
    ...
    for i in range (0,nbr_jour):
        ...
        compteur = tk.Label(wnd, text=f'Day : {i+1}', font='Helvetica 13 bold')
        compteur.place(x=720, y=5)
